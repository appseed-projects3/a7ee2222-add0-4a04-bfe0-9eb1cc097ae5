...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-24 12:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a7ee2222-add0-4a04-bfe0-9eb1cc097ae5.git
$ cd a7ee2222-add0-4a04-bfe0-9eb1cc097ae5
```
